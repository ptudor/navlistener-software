...
| **regression fix** | Klobuchar azimuth `A` evaluated in **radians** (not semicircles) | IS-GPS-200N §20.3.3.5.2.5. Code (iono.go) already cites this and documents radians; the "(semicircles)" mislabel is in **docs/MATH.md §7.1** only | ✅ backed (code correct; MATH.md doc note open) |
