...
FORBIDDEN = ("CONFIG_NVF_UPDATE_TEST_KEYS", "CONFIG_NVF_UPDATE_PROFILE_OPEN", "CONFIG_NVF_SETUP_CONSOLE_PASSWORD", "CONFIG_NVF_MANIFEST_FACTORY_INIT",
...
OPEN_FORBIDDEN = ("CONFIG_NVF_UPDATE_TEST_KEYS", "CONFIG_NVF_UPDATE_PROFILE_TRUSTED", "CONFIG_NVF_MANIFEST_FACTORY_INIT",
