...
int main(void)
{
    ...
    assert(ubx_version_is_m9n(version, 70));
    version[51] = 'X'; assert(!ubx_version_is_m9n(version, 70));
    version[51] = 0; assert(!ubx_version_is_m9n(version, 69));
    ...
    assert(ubx_version_is_m9n(version, sizeof version));
