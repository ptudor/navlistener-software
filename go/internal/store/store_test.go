...
func TestNavFrameRowMatchesColumnOrder(t *testing.T) {
	...
	f := &NavFrame{
		...
		Provenance: "local", CredentialTier: "hardware_mtls",
		CredentialFingerprint: "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
		AttestationTier:       "verified_v1_core",
		HardwareTrust:         "trusted", ManufacturerAuthorityID: "test-manufacturer",
		CommissioningFingerprint: "fedcba9876543210fedcba9876543210fedcba9876543210fedcba9876543210",
	...
	want := map[string]any{
		...
		"credential_tier":        "hardware_mtls",
		"credential_fingerprint": "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
		"attestation_tier":       "verified_v1_core",
		"hardware_trust":         "trusted", "manufacturer_authority_id": "test-manufacturer",
		"commissioning_fingerprint": "fedcba9876543210fedcba9876543210fedcba9876543210fedcba9876543210",
