...
func TestNavFrameRowMatchesColumnOrder(t *testing.T) {
	...
	f := &NavFrame{
		...
		AttestationTier:       "verified_v2_complete",
		HardwareTrust:         "trusted", CommissioningFingerprint: "fedcba9876543210fedcba9876543210fedcba9876543210fedcba9876543210",
	...
	want := map[string]any{
		...
		"attestation_tier":       "verified_v2_complete",
		"hardware_trust":         "trusted", "commissioning_fingerprint": "fedcba9876543210fedcba9876543210fedcba9876543210fedcba9876543210",
